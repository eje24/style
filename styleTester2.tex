...
\usepackage[nomarginnum,homework,monocolor=Violet,name={Ezra Erives},claimcolor=Violet]{eje}
\usepackage{fancyhdr}
\usepackage{sectsty}


\newcommand{\testBB}{\ensuremath{\mathbb{Z}}}
...
\begin{problembox}{2}{Silverster's Criterion}
    Prove Sylvester's Criterion
\end{problembox}
\begin{solution}
...
\begin{problembox}{3}{Conjugacy classes in $M$}
    Classify the conjugacy classes of isometries of $\RR^2$.
\end{problembox}
